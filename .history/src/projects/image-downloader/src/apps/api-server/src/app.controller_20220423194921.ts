...
import { SearchResult, findSubmission } from '@zougui/image-downloader.furaffinity';
import {
...
(async () => {
  ...
  const sub = await findSubmission('https://www.furaffinity.net/view/46858738');
  console.log('sub', sub.description);
