export declare module 'imagescript' {
  export class Image {
    ...
    encode(compression?: number, metadata?: PNGMetadata): Promise<Uint8Array>;
    encode(metadata?: PNGMetadata): Promise<Uint8Array>;

    encodeJPEG(quality?: number): Promise<Uint8Array>;

    encodeWEBP(quality?: null | number): Promise<Uint8Array>;

    static encode(data: Buffer | Uint8Array): Promise<Image>
  ...
  export class GIF extends Array<Frame> {
    ...
    static decode(data: Buffer | Uint8Array, onlyExtractFirstFrame?: boolean): Promise<GIF>;
