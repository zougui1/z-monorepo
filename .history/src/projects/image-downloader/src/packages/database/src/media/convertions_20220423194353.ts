...
export const convertUnprocessedMedia = (unprocessedMedia: UnprocessedMediaDocument, fileData: CreateFileData): Media => {
  const media = {
    posts: [convertUnprocessedMediaToPost(unprocessedMedia, fileData)],
    createdAt: new Date(),
    updatedAt: new Date(),
  };
...
export const convertUnprocessedMediaToPost = (unprocessedMedia: UnprocessedMediaDocument, fileData: CreateFileData): MediaPost => {
