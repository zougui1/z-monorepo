...
console.log('are equal:', SomethingA === SomethingB);
console.log('are prototypes equal:', SomethingA.prototype === SomethingB.prototype);

__decorate([
  Reflect.metadata('key', 'value defined in A'),
], SomethingA.prototype, 'property');

console.log('metadata(SomethingA.property):', Reflect.getMetadata('key', SomethingA.prototype, 'property'));
console.log('metadata(SomethingB.property):', Reflect.getMetadata('key', SomethingB.prototype, 'property'));
