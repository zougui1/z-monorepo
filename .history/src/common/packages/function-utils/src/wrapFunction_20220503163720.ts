export function wrapFunction<T>(func: (() => T), options: WrapFunctionOptions<T>): T;
export function wrapFunction<T>(func: (() => Promise<T>), options: WrapFunctionOptions<T>): Promise<T>;
export function wrapFunction<T>(func: (() => T | Promise<T>), options: WrapFunctionOptions<T>): T | Promise<T>;
export function wrapFunction<T>(func: (() => T | Promise<T>), options: WrapFunctionOptions<T>): T | Promise<T> {
  try {
    const result = func();
