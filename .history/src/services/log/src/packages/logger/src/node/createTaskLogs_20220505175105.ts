...
export type TaskLogsConstructor<
  ...
  TErrorCauseOut extends Cause | void = TErrorCause,
> = {
  startDataFormatter: <TStartDataOut extends UnknownObject>(formatter: (data: TStartData) => TStartDataOut) => TaskLogsConstructor<
    TStartData,
    TSuccessData,
    TErrorCause,
    TStartDataOut,
  ...
  successDataFormatter: <TSuccessDataOut extends UnknownObject>(formatter: (data: TSuccessData) => TSuccessDataOut) => TaskLogsConstructor<
    TStartData,
    TSuccessData,
    TErrorCause,
    TStartDataOut,
  ...
  errorDataFormatter: <TErrorCauseOut extends Cause>(formatter: (cause: TErrorCause) => TErrorCauseOut) => TaskLogsConstructor<
    TStartData,
    TSuccessData,
    TErrorCause,
    TStartDataOut,
