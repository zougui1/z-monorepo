...
export const createTaskLogs = <
  ...
  TStartDataOut extends UnknownObject | void = any,
  TSuccessDataOut extends UnknownObject | void = any,
  TErrorCauseOut extends Cause | void = any,
>(
  logOptions: CreateTaskLogsOptions<TStartData, ResolvedResultData<TSuccessData>, TErrorCause, TStartDataOut, TSuccessDataOut, TErrorCauseOut>,
...
> {
  ...
  formatters?: {
    start?: ((data: TStartData) => TStartDataOut) | undefined;
    success?: ((data: TSuccessData) => TSuccessDataOut) | undefined;
    error?: ((cause: TErrorCause) => TErrorCauseOut) | undefined;
  } | undefined;
