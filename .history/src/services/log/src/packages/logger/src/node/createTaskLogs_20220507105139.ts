    ...
    ? <TFunc extends (...args: any[]) => any>(
      func: PromiseValue<ReturnType<TFunc>> extends Result<TSuccessData>
        ? Parameters<TFunc> extends Args<TStartData>
          ...
          : void
        : void
    ) => ((...args: Args<TStartData> extends any[] ? Args<TStartData> : any[]) => Promisify<PromiseValue<ReturnType<TFunc>>, TSuccessData>)
    : void;
...
type Promisify<T, Type> = IsPromise<T, Type> extends void ? Type : Promise<Type>;
