...
>(
  ...
  class TaskLog {
    ...
    static wrap = <
      HasArgs extends boolean | void = TStartData extends AnyObject ? TStartData['args'] extends any[] ? boolean : void : void,
      TFunc extends ((...args: any[]) => any) = ((...args: any[]) => any),
      >(func: HasArgs extends boolean ? TFunc : void): HasArgs extends boolean ? ((...args: Parameters<TFunc>) => ReturnType<TFunc>) : never => {
      if (!func) {
        throw new Error('t');
      }
...
export type TaskLogsConstructor<
  ...
  wrap: <TFunc extends (...args: any[]) => any>(func: TFunc) => ((...args: Parameters<TFunc>) => ReturnType<TFunc>);
