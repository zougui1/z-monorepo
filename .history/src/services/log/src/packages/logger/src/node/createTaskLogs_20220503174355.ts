...
> {
  ...
  messages: {
    start: ((context: LogContext<RequiredLogData<TStartData>, undefined>) => string) | string;
    success: ((context: LogContext<RequiredLogData<TSuccessData>, undefined>) => string) | string;
