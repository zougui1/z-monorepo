...
import { wrapFunction } from '@zougui/common.function-utils';
...
>(
  logOptions: CreateTaskLogsOptions<TStartData, RequiredLogData<TSuccessData>, TErrorCause>,
): TaskLogsConstructor<TStartData, RequiredLogData<TSuccessData>, TErrorCause> => {
  ...
  const SuccessLog = createLog<RequiredLogData<TSuccessData>, void>(
    {
      ...commonLogOptions,
  ...
  class TaskLog {
    ...
    success = (...args: LogArguments<RequiredLogData<TSuccessData>, void>): Log<RequiredLogData<TSuccessData>, undefined> => {
      const inputData = args[0]?.data;
      ...
      const actualArgs = actualData ? [
        ...
        ...args.slice(1),
      ] as LogArguments<RequiredLogData<TSuccessData>, void> : args;
...
> = {
  ...
  wrap: Args<TStartData> extends any[]
    ? <TFunc extends (...args: any[]) => any>(
      func: ReturnType<TFunc> extends TSuccessData
    ...
    : void;
} & Constructor<TaskLogs<TStartData, RequiredLogData<TSuccessData>, TErrorCause, TStartDataOut, RequiredLogData<TSuccessDataOut>, TErrorCauseOut>>;
