...
>(
  logOptions: CreateLogOptions<TData, TCause>,
      ...
      super(
        {
          ...
          message: toFunction(logOptions.message) as (((context: LogContext<RequiredLogData<TData>, RequiredLogCause<TCause>>) => string) | string),
        },
...
> {
  ...
  message: ((context: LogContext<RequiredLogData<TData>, RequiredLogCause<TCause>>) => string) | string;
