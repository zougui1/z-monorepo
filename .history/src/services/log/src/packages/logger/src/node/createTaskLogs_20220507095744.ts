...
> {
  ...
  formatters?: {
    start?: ((payload: { data: TStartData }) => TStartDataOut) | undefined;
    success?: ((payload: { data: TSuccessData }) => TSuccessDataOut) | undefined;
    error?: ((payload: { cause: TErrorCause }) => TErrorCauseOut) | undefined;
  } | undefined;
  messages: {
    start: ((context: LogContext<RequiredLogData<TStartDataOut>>) => string) | string;
    success: ((context: LogContext<RequiredLogData<TSuccessDataOut>>) => string) | string;
    error: ((context: LogContext<UnknownObject, RequiredLogCause<TErrorCauseOut>>) => string) | string;
  };
