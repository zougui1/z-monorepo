import { SliceCaseReducers, PayloadActionCreator, ActionCreatorWithoutPayload, CaseReducerActions } from '@reduxjs/toolkit';
...
export interface InternalSliceState<
  ...
  CaseReducers extends SliceCaseReducers<State> = SliceCaseReducers<State>,
> {
  actions: OverridenActions<CaseReducerActions<CaseReducers>>;
